...
Kurucu metotlar ilgili sınıftan bir nesne üretmeye çalıştığınızda daha nesne üretme aşamasında çalıştırılan özel metotlardır (fonksiyonlardır). __Kurucu metotların isimleri Sınıf ismiyle aynı olmak zorundadır.__ __Dönüş tipi olarak veya void olarak herhangi bir tanımlama yapılmasına gerek yoktur.__

__"new"__ anahtar kelimesi ile nesne üretirken kurucu metot çağrımı yapılır. İki tip kurucu metot vardır:
